...
if __name__ == '__main__':
    ...
    impute_when_missing = [{'feature': 'Area', 'impute_with': 'MODE'},
                           {'feature': 'Perimeter', 'impute_with': 'MODE'},
                           {'feature': 'Compactness', 'impute_with': 'MODE'},
                           {'feature': 'kernelLength', 'impute_with': 'MODE'},
                           {'feature': 'KernelWidth', 'impute_with': 'MODE'},
                           {'feature': 'AsymmetryCoeff', 'impute_with': 'MODE'},
                           {'feature': 'KernelGrooveLength', 'impute_with': 'MODE'}]
    ...
    K=5
    k=3
    while(k<=K):                    # Aquí creamos el modelo knn, siendo k=n_neighbors, weights como decidimos que valgan las distancias, uniform cada una vale lo mismo, y distance que valgan 
        ...
        print("Esta es la prueba de k= "+str(k))
